...
export const MOCK_ORDERS: Order[] = [
  ...
  },
  {
    ...
    status: 'fulfilled',
    items: [
      { id: 'ord-002-item-1', orderId: 'ord-002', productType: 'course', productId: 'course-private-core', productName: '常规私教 20 次', quantity: 1, unitPrice: 9000, totalAmount: 9000, memberAssetId: 'asset-1-private-20' },
    ],
    totalAmount: 9000,
    paidAmount: 9000,
    createdAt: '2026-01-01T12:00:00+08:00',
    updatedAt: '2026-01-01T12:05:00+08:00',
    salesId: '1',
    storeId: '1',
  },
  {
    ...
    status: 'fulfilled',
    items: [
      { id: 'ord-003-item-1', orderId: 'ord-003', productType: 'card', productId: 'c5', productName: '50次次卡', quantity: 1, unitPrice: 6800, totalAmount: 6800, memberAssetId: 'asset-3-card-50' },
    ],
    totalAmount: 6800,
    paidAmount: 6800,
    createdAt: '2025-01-01T10:00:00+08:00',
    updatedAt: '2025-01-01T10:05:00+08:00',
    salesId: '2',
    storeId: '1',
  },
  {
    ...
    status: 'fulfilled',
    items: [
      { id: 'ord-004-item-1', orderId: 'ord-004', productType: 'card', productId: 'c8', productName: '瑜伽季卡', quantity: 1, unitPrice: 3600, totalAmount: 3600, memberAssetId: 'asset-5-card-c8' },
    ],
    totalAmount: 3600,
    paidAmount: 3600,
    createdAt: '2026-03-01T09:30:00+08:00',
    updatedAt: '2026-03-01T09:35:00+08:00',
    salesId: '1',
    storeId: '1',
  },
  {
...
export const MOCK_PAYMENTS: Payment[] = [
  ...
  },
  {
    ...
    amount: 9000,
    method: 'wechat',
    transactionNo: 'wx202601011200001',
    initiatedAt: '2026-01-01T12:00:00+08:00',
    paidAt: '2026-01-01T12:03:00+08:00',
    reconciledAt: '2026-01-02T09:00:00+08:00',
  },
  {
    id: 'pay-003',
    orderId: 'ord-003',
    ...
    amount: 6800,
    method: 'alipay',
    transactionNo: 'ali202501011000001',
    initiatedAt: '2025-01-01T10:00:00+08:00',
    paidAt: '2025-01-01T10:03:00+08:00',
    reconciledAt: '2025-01-02T09:00:00+08:00',
  },
  {
    id: 'pay-004',
    orderId: 'ord-004',
    ...
    amount: 3600,
    method: 'wechat',
    transactionNo: 'wx202603010930001',
    initiatedAt: '2026-03-01T09:30:00+08:00',
    paidAt: '2026-03-01T09:33:00+08:00',
...
export const MOCK_FINANCE_LEDGER_ENTRIES: FinanceLedgerEntry[] = [
  ...
  },
  {
    ...
    amount: 9000,
    direction: 'income',
    occurredAt: '2026-01-01T12:03:00+08:00',
    description: '常规私教 20 次收款',
  },
  {
    id: 'ledger-005',
    sourceType: 'payment',
    ...
    amount: 6800,
    direction: 'income',
    occurredAt: '2025-01-01T10:03:00+08:00',
    description: '50次次卡收款',
  },
  {
    id: 'ledger-006',
